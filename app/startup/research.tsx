...
import { ArrowLeft, RefreshCw, AlertTriangle, Search, ChevronRight } from "lucide-react-native";

export default function ResearchScreen() {
  const { content, status, error, hasData } = useResearch();
  ...
  return (
    <SafeAreaView style={styles.safe} edges={["top"]}>
      <View style={styles.topBar}>
        ...
        <Text style={styles.topTitle}>Research Agent</Text>
        {hasData && (
          <TouchableOpacity onPress={() => rerunAgent("research")} style={styles.regenBtn}>
      ...
      <ScrollView style={styles.scroll} contentContainerStyle={styles.content} showsVerticalScrollIndicator={false}>
        ...
        {status === "running" && (
          <View style={styles.loadingBox}>
            <Loader size={32} label="Conducting TAM/SAM/SOM market research..." color={COLORS.accent} />
          </View>
        )}
        ...
        {!hasData && status === "idle" && (
          <View style={styles.empty}>
            <Search size={48} color={COLORS.textMuted} style={{ marginBottom: 14, opacity: 0.4 }} />
            <Text style={styles.emptyTitle}>No market research yet</Text>
            <Text style={styles.emptySub}>
              Run the startup plan generator to get AI-powered market analysis.
            </Text>
            <Button
              label="Generate Plan"
          ...
          <>
            ...
            <View style={styles.navRow}>
              <Button
                ...
                onPress={() => router.push("/startup/coding")}
                variant="ghost"
                size="sm"
